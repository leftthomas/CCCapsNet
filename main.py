...
if __name__ == '__main__':
    ...
    routing_scheduler = MultiStepRI(model, milestones=[10, 30, 50], verbose=True)
    dropout_scheduler = MultiStepDropout(model, milestones=[20, 40, 60], addition=[0.1, 0.3, 0.5], verbose=True)

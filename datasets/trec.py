...
def trec_dataset(directory='data/trec/', train=False, test=False, train_filename='train_5500.label',
                 test_filename='TREC_10.label', check_files=['train_5500.label'],
                 urls=['http://cogcomp.org/Data/QA/QC/train_5500.label', 'http://cogcomp.org/Data/QA/QC/TREC_10.label'],
                 fine_grained=False):
    """
    ...
    **Citation:**
    ...
    Args:
        ...
        fine_grained (bool, optional): Whether to use 50-class instead of 6-class labeling.
